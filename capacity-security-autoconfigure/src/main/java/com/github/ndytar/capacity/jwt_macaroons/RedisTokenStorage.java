...
public class RedisTokenStorage implements TokenStorageService {
    ...
    public void saveJwt(String jwtId, String deviceId, Duration ttl) {
        try {
            ...
            log.info("For save jwt id: {}", RedisKeys.jwt(jwtId));
            log.info("For save jwt isExiste: {}", existsJwt(jwtId));
...
try {
    ...
    public boolean existsJwt(String jwtId) {
        try {
            log.info("For isExiste:  jwt id: {}", RedisKeys.jwt(jwtId));
            log.info("For isExiste:  IsExistjwt: {}", Boolean.TRUE.equals(redisTemplate.hasKey(RedisKeys.jwt(jwtId))));
    ...
    public void deleteAllJwt() {
        ...
        log.info("setKeys avant rev: {}", keys);
